...
namespace lib_presentaciones.Implementaciones
{
    ...
    {
        private IPedidosComunicacion? iComunicacion = null;

        public PedidosPresentacion(IPedidosComunicacion iComunicacion)
        {
        ...
        public async Task<List<Pedidos>> Buscar(Pedidos entidad, string tipo)
        {
            var lista = new List<Pedidos>();
            var datos = new Dictionary<string, object>();
